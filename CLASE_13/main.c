...
int main()
{
    ...
    pantalla_altaForzada(array,QTY,"Wilde","Las Flores 50",55,0);
    pantalla_altaForzada(array,QTY,"Avellaneda","Belgrano 250",2,0);
    pantalla_altaForzada(array,QTY,"Bernal","Cerrito 300",3,0);
    pantalla_altaForzada(array,QTY,"Quilmes","Lavalle 450",500,1);
    pantalla_altaForzada(array,QTY,"Calzada","Mitre 150",50,1);

    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,0,"video.avi","20911911915",900);
    ...
    cont_altaForzada(contrataciones,LEN_CONT,array,QTY,2,"video3.avi","30911911915",300);
    ...
    do
    {
        getValidInt("\n\n1.Alta\n2.Baja\n3.Modificar\n4.Mostrar\n5.Ordenar\n6.Mostrar Debug\n7.Contratar\n8.Listado Menor a 10\n9.Listado Pantallas Menor precio Promedio\n10.Listado Ordenado POR PRECIO\n99.Salir\n","\nNo valida\n",&menu,1,99,1);
        switch(menu)
        {
            case 1:
            ...
            case 8:
                listado_pantallasMenor (array, QTY,10);
                break;

            case 9:
                promedio_preciopantalla (array,QTY,&promedio);
                listado_pantallasMenorPromedio (array,QTY,&promedio);
                break;

            case 10:
                listado_ordenado (array, QTY);
                listado_pantallas (array, QTY);
                break;
